<?php include('header.php'); ?>
	...
	<div class="recipient_reg" style="background-color:#272327;">
		...
		<div class="formstyle" style="float: right;padding:25px;border: 1px solid lightgrey;margin-right:150px; margin-bottom:30px;background-color:#f3f3f8;color:#141313;">
		<form enctype="multipart/form-data" method="post" class="text-center" style=" height:500px; width:1200px">
			 <div class="col-md-12">
