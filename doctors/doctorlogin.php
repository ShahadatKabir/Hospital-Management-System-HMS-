...
<div class="container-fluid">
		<div class="header">
		<img src="../img/a.jpg" alt="" height="400px" width="100%">
	...
	<div class="login" style="background-color:#fff;">
		<h1 class="text-center" style="background-color:royalblue;color: #fff;">Our certified Experienced doctors</h1>
			<div class="formstyle" style="padding: 10px;border: 1px solid lightgrey;margin-right: 376px;margin-left: 406px; margin-bottom: 25px;background-color:black;color:#141313;">
