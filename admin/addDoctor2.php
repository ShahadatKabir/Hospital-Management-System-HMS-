...
<?php include('header.php'); ?>
	...
	<div class="recipient_reg" style="background-color:#272327;">
		...
		<div class="formstyle" style="float: right;padding:25px;border: 1px solid lightgrey;margin-right:520px; margin-bottom:30px;background-color: #101011;color:#d4530d;;">
