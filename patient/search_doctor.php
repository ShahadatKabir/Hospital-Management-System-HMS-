	...
	<div class="search" style="background-color:;">
		<h3 class="text-center" style="background-color:#272327;color: #fff;padding: 5px;">Search Here</h3>
		 ...
		 <div class="formstyle" style="padding:70px;height:500px; width:500px;border: 1px solid lightgrey;margin-right: 293px;margin-bottom: 30px;background-color:#f3f3f8;color:#141313;width: 530px;margin-left: 400px;">
					<form action="search_result.php" method="post" class="form-group" style="font-size:16px;">
					...
					<button name="submit" type="submit" style="margin-left:43px;width:108px;border-radius: 3px; border: 4px thin black; background-color: grey; color:black; padding:10px; font-size:12px; " class="btn btn-info">Search</button> 
