...
<div class="login" style="background-color:#fff;">
		<h3 class="text-center" style="background-color:#272327;color: #fff;">My Details</h3>
			<div class="formstyle" style=" height:500px; width:500px; float: right;padding-top:40px;border: 1px solid lightgrey;margin-right:600px; margin-bottom:30px;background-color:#f3f3f8;color:#141313;">
	...
	<button name="submit" type="submit" style="margin-left:43px;width:108px;border-radius: 3px; border: 4px thin black; background-color: grey; color:black; padding:10px; font-size:12px; " class="btn btn-info">UpdateProfile</button> 
