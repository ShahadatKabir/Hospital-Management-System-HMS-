		...
		<h3 class="text-center" style="background-color:#272327;color: #fff;padding: 5px;">My Appoinment</h3>
			...
			<div class="all_user" style="margin-top:0px; margin-left: 40px;">
				<?php 
					...
					if($count>=1){
						echo "<table border='1' align='center' cellpadding='32' height='500px' width='1200px' style='font-size:16px;'>
							<tr >
						...
						while($row=mysqli_fetch_array($result)){
								...
								echo "<td>".$row['tyme']."</td>";
						?>
								<td><a href="cancel_Booking.php?booking_id=<?php echo $row[0]; ?>">Cancel</a></td>;
						<?php
								echo "</tr>";
						}
						echo "</table>";
