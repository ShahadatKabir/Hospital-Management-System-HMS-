 ...
 ?>
	...
	<!-- 	booking info-->
		...
		<h3 class="text-center" style="background-color:#272327;color: #fff;">Book Appoinment</h3>
			<div class="formstyle" style="float: right;padding:20px;height:500px; width:500px;border: 1px solid lightgrey;margin-right:620px; margin-bottom:30px;background-color:#f3f3f8;color:#141313;">
			...
			<!-- confirming booking -->
					<?php
						...
						$sql = " INSERT INTO booking (dname,userid,dcontact,expertise,fee, pname,pcontact,email,addres,dates,tyme)
